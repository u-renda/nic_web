		...
		<section class="body-sign">
			<div class="center-sign">
				...
				<section class="panel panel-sign form-wizard" id="w1">
					<form action="<?php echo $this->config->item('link_member_invalid').'?c='.$result->short_code; ?>" method="post" novalidate="novalidate" enctype="multipart/form-data" id="form-register">
						<input type="hidden" name="id" value="<?php echo $result->id_member; ?>">
						<input type="hidden" name="selfidcard_number" id="selfidcard_number" value="<?php echo $result->idcard_number; ?>">
						<input type="hidden" name="selfname" id="selfname" value="<?php echo $result->name; ?>">
						<input type="hidden" name="selfphone_number" id="selfphone_number" value="<?php echo $result->phone_number; ?>">
						<input type="hidden" name="selfemail" id="selfemail" value="<?php echo $result->email; ?>">
						...
						<div class="panel-footer">
							<ul class="pager">
								...
								<li class="finish hidden pull-right">
									<button type="submit" value="submit" name="submit" class="btn-finish" id="submit_member_invalid">Finish</button>
								</li>
								<li class="next">
